...
6. **Offer the first refresh.** Ask whether to run **`/repo-memory:refresh-memory`** now to derive real conventions + the architecture graph from this repo. If yes, hand off to that skill.
